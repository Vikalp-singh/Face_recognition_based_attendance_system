...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'vikalp18singh@gmail.com' ")
...
window.configure(background='#2d420a') ## mehandi volor ##

frame1 = tk.Frame(window, bg="#c79cff") ## puprle color ##
frame1.place(relx=0.11, rely=0.17, relwidth=0.39, relheight=0.80)

frame2 = tk.Frame(window, bg="#c79cff")
frame2.place(relx=0.51, rely=0.17, relwidth=0.38, relheight=0.80)

message3 = tk.Label(window, text="Face Recognition Based Attendance Monitoring System MCA Department (H.R.I.T)" ,fg="white",bg="#2d420a" ,width=88 ,height=1,font=('comic', 20, ' bold '))
...
datef = tk.Label(frame4, text = day+"-"+mont[month]+"-"+year+" | ", fg="#ff61e5",bg="#2d420a" ,width=100 ,height=1,font=('comic', 22, ' bold '))
